                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="form-group col-md-12">
                                        ...
                                        <input type="text" class="form-control" id="position-name" name="position-name" />
                                    </div>
<#--                                    <div class="form-group col-md-12">-->
<#--                                        <label for="position-address">职位地址</label>-->
<#--                                        <input type="text" class="form-control" id="position-address" name="position-address" disabled/>-->
<#--                                    </div>-->
                                    <div class="form-group col-md-12">
                                    ...
                                    <div class="form-group col-md-12">
                                        <button id="submit" class="btn btn-primary ajax-post" target-form="add-form">确 定</button>
